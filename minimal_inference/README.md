> Modified by AnifLive-TTS in 2026; API documentation links adapted.
...
python export_onnx.py \
    --gpt_path "pretrained_models/GPT_weights_v2ProPlus/example_v2proplus.ckpt"
    --sovits_path "pretrained_models/SoVITS_weights_v2ProPlus/example_v2proplus.pth"
    --cnhubert_base_path pretrained_models\chinese-hubert-base
    --bert_path pretrained_models\chinese-roberta-wwm-ext-large
    --output_dir  "onnx_export/example_v2proplus"
...
python onnx_to_fp16.py \
    --input_dir "onnx_export/example_v2proplus" \
    --output_dir "onnx_export/example_v2proplus_fp16"
```
...
python run_onnx_streaming_inference.py \
    --onnx_dir onnx_export/example_v2proplus_fp16 \
...
python run_optimized_inference.py --onnx_dir onnx_export/example_v2proplus_fp16 --webui
```
...
python onnx2trt.py \
    --input_dir onnx_export/example_v2proplus_fp16 \
    --output_dir onnx_export/example_v2proplus_fp16
...
👉 **[Check the AnifLive-TTS API documentation](../docs/API_EN.md)**
