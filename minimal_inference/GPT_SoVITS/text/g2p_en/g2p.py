...
# Changes: fail-fast offline NLTK resource loading and warning cleanup.
# See minimal_inference/ANIFLIVE_TTS_PROVENANCE.json for details.
# /usr/bin/python
'''
...
for resource in ('taggers/averaged_perceptron_tagger_eng', 'corpora/cmudict'):
    try:
        nltk.data.find(resource)
    except LookupError as error:
        raise RuntimeError(
            f"Required offline NLTK resource is missing: {resource}"
        ) from error
