...
<img src="assets/aniflive-tts-studio-demo.gif" alt="AnifLive-TTS Studio 操作展示" width="960">
...
| Early-Exit Transformer 草稿模型 | 即使只預測一個草稿標記，前 17 個標記路徑仍慢 50–61%，草稿成本高於驗證收益 | 不採用 |
...
Studio 新增資料集準備與審核、訓練、檢查點續訓、TensorRT 轉換、評估及模型安裝。
